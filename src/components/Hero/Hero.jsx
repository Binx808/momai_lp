    ...
    <section id="hero" className="bg-mom-ai-beige py-20" style={{ backgroundImage: "url(/assets/mom_ai_logo.png)", backgroundRepeat: "repeat", backgroundSize: "100px", backgroundPosition: "center", backgroundBlendMode: "overlay", backgroundColor: "rgba(245, 245, 220, 0.85)" }}>
      <div className="container mx-auto px-6 flex flex-col md:flex-row items-center">
        ...
        <div className="md:w-1/2 md:pl-12 text-center md:text-left">
          ...
          <a href="https://app.virtuals.io/geneses/1539" className="bg-mom-ai-orange-button text-white px-8 py-3 rounded-md hover:bg-opacity-90 transition duration-150 text-lg font-semibold" target="_blank" rel="noopener noreferrer">Join $RIKA Genesis Launch</a>
        </div>
      </div>
    </section>
  );
